/*
 * Keeper's Menu  Plugin.cs
 * A mod menu for Gorilla Tag with over 1000+ mods
 *
 * Copyright (C) 2026  Protogenreal Software
...
namespace kMenu
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        {
            // Set console title
            Console.Title = $"Keeper's Menu // Build {PluginInfo.Version}";
            instance = this;
...
{logoLines}
    ...
    for details see `https://github.com/protogenreal/keepers-menu/GPL/WARRANTY`
    
    This is free software, and you are welcome to redistribute it under certain conditions;
    see `https://github.com/protogenreal/keepers-menu/GPL/REDISTRIBUTION` for details.
");
            ...
            {
                if (File.ReadAllLines($"{PluginInfo.BaseDirectory}/kMenu_Preferences.txt")[0].Split(";;").Contains("Accept TOS"))
                    TOSPatches.enabled = true;
            }

            if (File.Exists($"{PluginInfo.BaseDirectory}/kMenu_DisableTelemetry.txt"))
        ...
        private static void LoadMenu()
        {
            ...
            GameObject Loader = new GameObject("kMenu_Loader");
        ...
        {
            GameObject kMenu = new GameObject("kMenu");
            kMenu.AddComponent<Plugin>();
        }
